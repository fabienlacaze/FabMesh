...
const ASSET_STYLE_PROMPTS = {
  ...
  voxel:        'voxel art, blocky voxel-style 3D, cubic geometry, clean voxels',
  'stylized-pbr':'stylized PBR, stylized hero-shooter game art style, hand-painted shading on PBR maps, clean game asset',
  'hand-painted':'hand-painted texture, stylized MMORPG fantasy, painterly diffuse, no realistic PBR maps, vibrant',
  ghibli:       'soft hand-drawn anime style, gentle warm palette, hand-drawn animation, expressive nature',
  pixar:        'modern 3D animated movie style, clean stylized 3D, family-friendly polish, expressive characters',
  ...
  minecraft:    'blocky low-fi voxel, cubic geometry, pixelated 16x16 texture, voxel inspired',
  ...
  claymation:   'claymation, plasticine model, soft stop-motion surface, British stop-motion clay style, handmade charm',
