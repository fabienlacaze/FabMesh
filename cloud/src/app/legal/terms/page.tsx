...
export default function TermsPage() {
  return (
    <main style={{ maxWidth: 760, margin: '0 auto', padding: '32px 24px', lineHeight: 1.65 }}>
      ...
      <h2>12. Copyright / DMCA — notice and takedown</h2>
      <p>
        Ayros Studio respects the intellectual property rights of others and
        expects users of the service and its marketplace to do the same. If you
        believe that content hosted by MyFabmesh.AI (including any marketplace
        listing, generated asset, or uploaded reference) infringes your
        copyright, you may send a notice in accordance with the U.S. Digital
        Millennium Copyright Act (DMCA, 17 U.S.C. §512) and equivalent
        provisions of French law (LCEN, art. 6).
      </p>
      <p>A valid takedown notice must include, in writing:</p>
      <ul>
        <li>Your physical or electronic signature (or that of a person authorized to act on behalf of the rights holder).</li>
        <li>Identification of the copyrighted work claimed to have been infringed.</li>
        <li>Identification of the allegedly infringing material, with enough detail to locate it (e.g. the listing URL or asset identifier).</li>
      ...
      <p>
        On receipt of a valid notice, Ayros Studio will act expeditiously to
        remove or disable access to the material concerned and will make
        reasonable efforts to notify the user who provided it, who may submit a
        counter-notification. You may also flag a marketplace listing directly
        through the in-app &ldquo;Report&rdquo; action, which routes to our{' '}
        <code>/api/market/report</code> endpoint.
      </p>

      <h3>Designated DMCA agent</h3>
      <p>
        Copyright notices must be sent to our designated agent:<br />
        <strong>[TO COMPLETE: designated DMCA agent name]</strong><br />
        Email: <strong>[TO COMPLETE: DMCA agent email]</strong><br />
        Postal address: <strong>[TO COMPLETE: DMCA agent postal address]</strong>
      </p>
      <p>
        Until this designation is completed and (where applicable) registered
        with the U.S. Copyright Office, notices may be addressed to{' '}
        <a href="mailto:fabien65400@hotmail.fr">fabien65400@hotmail.fr</a>.
      </p>

      <h2>13. Digital Services Act (EU) — point of contact</h2>
      <p>
        In accordance with Article 16 of Regulation (EU) 2022/2065 (the Digital
        Services Act), Ayros Studio operates a notice-and-action mechanism
        allowing any individual or entity to notify the presence of content they
        consider to be illegal. Notices may be submitted through the in-app{' '}
        &ldquo;Report&rdquo; action or by contacting the point of contact below,
        and should describe the content concerned, its location (e.g. the
        listing URL or asset identifier), and the reason it is considered
        illegal.
      </p>
      <p>
        On receipt of a sufficiently substantiated notice, Ayros Studio will
        assess it in a timely, diligent, non-arbitrary and objective manner and
        inform the notifier of the decision taken, including the available
        avenues of redress.
      </p>

      <h3>Single point of contact (DSA Art. 11 &amp; 16)</h3>
      <p>
        <strong>[TO COMPLETE: DSA point of contact name / department]</strong><br />
        Email: <strong>[TO COMPLETE: DSA point of contact email]</strong><br />
        Language(s) of communication: French, English.
      </p>
      <p>
        Until this point of contact is formally designated, illegal-content
