...
const ASSET_STYLE_PROMPTS = {
  ...
  voxel:        'voxel art, blocky voxel 3D style, cubic geometry, clean voxels',
  'stylized-pbr':'stylized PBR, hero-shooter stylized game style, hand-painted shading on PBR maps, clean game asset',
  'hand-painted':'hand-painted texture, painterly stylized fantasy MMO style, painterly diffuse, no realistic PBR maps, vibrant',
  ghibli:       'soft hand-drawn anime style, gentle warm palette, hand-drawn animation, expressive nature',
  pixar:        'polished 3D animated-film style, clean stylized 3D, family-friendly polish, expressive characters',
  ...
  minecraft:    'blocky voxel low-fi style, cubic geometry, pixelated 16x16 texture, voxel inspired',
  ...
  claymation:   'claymation, plasticine model, soft stop-motion surface, handmade clay-animation style, handmade charm',
