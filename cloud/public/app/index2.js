...
const ASSET_TYPE_PROMPTS = {
  ...
  insect: '3D game asset reference sheet, full body reference, long shot, full figure shot, distant camera, entire insect visible, body fills 60 percent of frame, ONE insect only, single arthropod, isolated, six legs, segmented body, hard exoskeleton, antennae, 3/4 isometric view, high three-quarter angle seen from above and to the side, top and side of the thorax and abdomen visible, all six legs clearly visible and separated, plain white background, even studio lighting, no shadows, exactly six legs, NO tail, no fur, NOT a mammal, NOT a quadruped, no extra limbs, no humanoid posture, NOT a front head-on view, NOT a symmetric front view, NOT a portrait, NOT a close-up, NOT a headshot, no second insect, no duplicate, no text, no UI',
  custom: '',
};
