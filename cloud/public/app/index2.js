...
const ASSET_TYPE_PROMPTS = {
  ...
  creature: 'full body shot from head to tail, entire creature visible head to feet, wide shot showing whole body, ONE creature only, single instance, isolated, full body, neutral stance, front view, facing camera, symmetric, plain white background, even studio lighting, no shadows, no other creatures, centered, clean silhouette, no text, no UI, no duplicate, NO portrait, NO headshot, NO close-up, NO head only, NO face only',
  ...
  animal: 'full body shot from nose to tail, entire animal visible head to feet, whole body in frame, wildlife photography of ONE animal only, single creature with ONE single tail only, full body lateral profile, all four feet flat on the ground, body horizontal parallel to floor, belly close to ground, four legs supporting the body from below, wide shot, distant camera, plain white background, even studio lighting, no shadows, NEVER bipedal, NEVER upright, NEVER standing on hind legs, NEVER humanoid posture, NEVER T-pose, NEVER cartoon mascot stance, exactly one tail, no extra tails, no multiple tails, no extra limbs, no humanoid anthropomorphism, no second animal, no duplicate, no text, no UI, NO portrait, NO headshot, NO close-up, NO head only, NO face only, NO bust shot, NO head and shoulders',
  custom: '',
};
