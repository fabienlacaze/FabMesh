...
(function () {
  ...
  const I18N = {
    fr: {
      ...
      'Tell us what is wrong with this AI-generated result. Reports are reviewed by a human. You do not need an account to report.':
        "Dites-nous ce qui ne va pas avec ce résultat généré par l’IA. Les signalements sont examinés par un humain. Aucun compte n’est nécessaire.",
      ...
      'Results are generated by AI models and may occasionally be inappropriate or inaccurate. If you see a generated result that should not have been produced, please tell us — reports are reviewed by a human.':
        'Les résultats sont générés par des modèles d’IA et peuvent parfois être inappropriés ou inexacts. Si vous voyez un résultat qui n’aurait pas dû être produit, signalez-le — les signalements sont examinés par un humain.',
      'Sending your report…': 'Envoi de votre signalement…',
      'Report sent. Thank you — a human will review it.':
        'Signalement envoyé. Merci — il sera examiné par un humain.',
