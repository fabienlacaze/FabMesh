...
class UniRigAR(ModelSpec):
    ...
    def __init__(self, llm, mesh_encoder, **kwargs):
        ...
        # FabMesh shim: disable flash_attn_2 backend (we have a pure-PyTorch shim)
        llm_config._attn_implementation = "eager"
        self.transformer = AutoModelForCausalLM.from_config(config=llm_config, attn_implementation="eager")
