...
def run_sf3d(source_image: str, mv_dir: str, glb_out: str) -> None:
    ...
    # MAJOR FINDING (2026-04-18): user pointed out that runs labelled
    # NORMALIZE=1 in AGENT_LOG were actually running NORMALIZE=0 because
    # this wrapper was force-setting it. Removed — bridge default
    # (NORMALIZE_ORIENT=1) now applies, mesh face points to +Z (three.js
    # convention).
